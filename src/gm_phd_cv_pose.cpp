...
GmPhdCvPose::StateHypothesis GmPhdCvPose::PredictHypothesis(const StateHypothesis& hypothesis) {
  static StateHypothesis predicted_hypothesis;
  ...
  // predicted_hypothesis.covariance = transition_matrix_ * hypothesis.covariance *
...
void GmPhdCvPose::PrepareTransitionMatrix(void) {
  transition_matrix_ = SquareMatrix<4u>::Zero();
...
void GmPhdCvPose::PrepareProcessNoiseMatrix(void) {
  process_noise_covariance_matrix_ = SquareMatrix<4u>::Zero();
...
void GmPhdCvPose::PredictBirths(void) {
  ...
  //   birth_hypothesis.covariance = 1.0 * SquareMatrix<4u>::Identity();
  ...
  //       calibrations_.observation_matrix * birth_hypothesis.covariance *
  //       calibrations_.observation_matrix.transpose();
  //   const auto kalman_gain =
  //       birth_hypothesis.covariance * calibrations_.observation_matrix.transpose() *
  //       innovation_covariance.inverse();
  //   const auto predicted_covariance =
  //       (SquareMatrix<4u>::Identity() - kalman_gain * calibrations_.observation_matrix) *
  //       birth_hypothesis.covariance;

  //   predicted_hypothesis_.push_back(PredictedHypothesis(birth_hypothesis, predicted_measurement,
