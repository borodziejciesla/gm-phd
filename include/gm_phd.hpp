...
class GmPhd : public CalibratedObject {
 ...
 protected:
  ...
  struct PredictedHypothesis {
    ...
    PredictedHypothesis(const Hypothesis h, const MeasurementSizeVector pm,
 ...
 private:
  ...
  void PredictExistingTargets(void) {
    ...
    std::transform(
        ...
        [this](const Hypothesis& hypothesis) {
          ...
          const auto kalman_gain = hypothesis.covariance *
                                   calibrations_.observation_matrix.transpose() *
          ...
          return PredictedHypothesis(predicted_state, predicted_measurement, innovation_covariance,
  ...
  void UpdateExistedHypothesis(void) {
    ...
    std::transform(predicted_hypothesis_.begin(), predicted_hypothesis_.end(),
                   predicted_hypothesis_.begin(), [this](const PredictedHypothesis& hypothesis) {
