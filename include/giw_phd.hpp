#ifndef GM_PHD_INCLUDE_GIW_PHD_HPP_
#define GM_PHD_INCLUDE_GIW_PHD_HPP_
...
namespace mot {
  ...
  class GiwPhd {
    ...
    public:
      explicit GiwPhd(const GmPhdCalibrations<state_size, measurement_size> & calibrations)
        : calibrations_{calibrations} {}

      virtual ~GiwPhd(void) = default;
...
#endif  //  GM_PHD_INCLUDE_GIW_PHD_HPP_
